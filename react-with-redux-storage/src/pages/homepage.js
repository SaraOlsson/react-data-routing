  ...
  return (
    <div>
      ...
      <pre>{`
          ...
          `}  <a href="https://github.com/SaraOlsson/react-with-local-storage/tree/master/react-with-redux-storage">Source code on GitHub</a>
              {`\n            `}
              <a href="https://reactgo.com/react-redux-hooks/">React Redux hooks tutorial with examples</a></pre>
